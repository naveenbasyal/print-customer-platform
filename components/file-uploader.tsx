            ...
            <div>
              {isDragActive ? (
                <div>
                  ...
                  <p className="text-xl font-semibold text-blue-600 mb-2">Drop your files here!</p>
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Upload Your PDFs</h3>
                  <p className="text-lg text-gray-600 mb-4">Drag & drop your files here, or click to browse</p>
