        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-1">
              <Link href="/">
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-gray-600 hover:text-[#3366ff] hover:bg-[#3366ff]/5 transition-all duration-200"
                >
            ...
            <Button
              variant="ghost"
              size="sm"
              className="md:hidden hover:bg-[#3366ff]/5"
              ...
              <div className="px-4 py-2 space-y-1">
                <Link href="/" onClick={() => setMobileMenuOpen(false)}>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="w-full justify-start text-gray-600 hover:bg-[#3366ff]/5"
                  >
                    <Home className="h-4 w-4 mr-2" />
                    Home
                  </Button>
