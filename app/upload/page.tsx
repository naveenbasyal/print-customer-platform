            ...
            <Card className="mb-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
              <CardHeader className="pb-4">
                <CardTitle className="text-blue-800 flex items-center">
                  <Calculator className="text-lg md:text-xl h-5 w-5 mr-2" />
                  Current Printing Rates
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-0">
          ...
          <Card className="mb-6 border border-gray-200 hover:border-[#3366ff]/30 transition-colors">
            <CardHeader>
              <CardTitle className="flex items-center space-x-3">
                ...
                <span className="text-lg md:text-xl">Select Your Files</span>
            ...
            <Card className="border border-gray-200 hover:border-[#3366ff]/30 transition-colors">
              <CardHeader>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                  ...
                  <div className="text-left mt-2 flex gap-x-2 justify-between flex-row-reverse sm:text-right">
